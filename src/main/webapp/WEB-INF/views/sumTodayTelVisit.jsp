                    ...
                    <div class="row">
                        ...
                        <table id="dynamic-table"
                            ...
                            <tr role="row">
                                ...
                                <th tabindex="0" aria-controls="dynamic-table" rowspan="1" colspan="1" style="text-align:center;" style="text-align:center;">
                                    记录
                                </th>
                            </tr>
                            </thead>
...
<script type="application/javascript">
    $(function () {
        ...
        function loadCusList() {
            ...
            var url = "/cusTel/form/sumByToday.json?deptId=";
