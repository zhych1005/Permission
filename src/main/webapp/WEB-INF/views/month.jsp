...
<div id="dialog-cus-form" style="display: none;">
    <form id="cusForm">
        <table class="table table-striped table-bordered table-hover dataTable no-footer" role="grid">
            ...
            <tr>
                <td><label for="remark">情况说明</label></td>
                <td><textarea name="remark" id="remark" class="text ui-widget-content ui-corner-all" rows="3"
                              cols="25"></textarea></td>
            </tr>
        </table>
    </form>
...
<tr role="row" class="cus-name odd" data-id="{{id}}"><!--even -->
    <td>{{id}}</a></td>
    <td><a href="#" class="cus-edit" data-id="{{id}}">{{cusname}}</a></td><%--客户--%>
...
<script type="application/javascript">
    $(function () {
        ...
        function loadCusList() {
            ...
            var url = "/user/form/countCusByMonth.json?deptId=${user.deptId}";
