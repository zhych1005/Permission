...
<body>
<div>
    <form action="/file/uploadFile.json" class="dropzone well dz-clickable" method="post"
          enctype="multipart/form-data">
        <div class="dz-default dz-message">
            <span>
                <span class="bigger-150 bolder">
                    <i class="ace-icon fa fa-caret-right red">
                    </i>
                    选择图片文件并上传
                </span><br>
...
<td>
    <div class="hidden-sm hidden-xs action-buttons" style="text-align:center;">
       <a class="red delete-file" href="/file/deleteFile.json?fileid={{fileid}}&filename={{filename}}">
